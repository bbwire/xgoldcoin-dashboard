      ...
      <v-card>
        ...
        <v-card-text>
          ...
          <v-form ref="form" lazy-validation>
              ...
              <v-text-field v-model="form_data.xgc_price" :rules="[rules.required]" label="Xgold price" outlined clearable></v-text-field>
              
              <v-text-field v-model="form_data.btc_amount" :rules="[rules.required]" label="XGC Amount" outlined clearable></v-text-field>
