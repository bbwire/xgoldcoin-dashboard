    ...
    <v-card>
      ...
      >
        ...
        <template v-if="$vuetify.breakpoint.smAndUp">
          ...
          <v-btn color="accent" depressed @click="dialog = true">
            <v-icon>mdi-plus</v-icon> Make a deposit
          </v-btn>
      ...
      <v-card>
        ...
        <v-card-text>
          ...
          <v-form ref="form" lazy-validation>
              ...
              <v-text-field v-model="form_data.btc_price" :rules="[rules.required]" label="Bitcoin price" outlined clearable></v-text-field>
              
              <v-text-field v-model="form_data.btc_amount" :rules="[rules.required]" label="BTC Amount" outlined clearable></v-text-field>
