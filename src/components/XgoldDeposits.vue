      ...
      <v-card>
        ...
        <v-card-text>
          ...
          <v-form ref="form" lazy-validation>
              ...
              ></v-text-field>
              <v-text-field v-model="coin_data.xgoldcoin.usd" readonly :rules="[rules.required]" label="Xgold price" outlined clearable></v-text-field>
  ...
  export default {
    ...
    methods: {
      ...
      calculateAmount (amount) {
        let result = amount / this.coin_data.xgoldcoin.usd
        this.form_data.xgc_amount = result
      },
      addMember () {
